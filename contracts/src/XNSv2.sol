...
/// - During the onboarding period (146 days after XNSv2 contract deployment, 1 year after v1 deployment),
...
contract XNSv2 is EIP712, Ownable2Step, ReentrancyGuard {
    ...
    uint256 public constant ONBOARDING_PERIOD = 146 days;
    ...
    ///
    /// **Note:**
    /// - During the onboarding period (146 days following contract deployment), the contract owner can
